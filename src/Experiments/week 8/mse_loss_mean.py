...
# from src.networks.mnist_var_dataset import MNISTVarDataset
...
if __name__ == '__main__':
    ...
    with open('results/mse_loss_std.csv', mode='w') as file:
        file_writer = csv.writer(file)

        file_writer.writerow(['MSE', 'TIME'])
