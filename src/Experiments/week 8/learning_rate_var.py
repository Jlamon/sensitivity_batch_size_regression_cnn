...
def main():
    ...
    # 0.0015 was found to be the best
    ...
    train_dataset = MNISTVarDataset(train.data, transform=transforms.ToTensor)
    test_dataset = MNISTVarDataset(test.data, transform=transforms.ToTensor)

    numpy.savetxt("./datasets/train_var.csv", train_dataset.means, delimiter=",")
...
if __name__ == '__main__':
    ...
    with open('results/learning_rate_var.csv', mode='w') as file:
