...
def main():
    ...
    for bs in batch_sizes:
        ...
        savetxt(f'losses/test_counter_median_bs_{bs}.csv', test_counter, delimiter=',')
        savetxt(f'losses/test_losses_median_bs_{bs}.csv', test_losses, delimiter=',')
        savetxt(f'losses/train_losses_median_bs_{bs}.csv', train_losses, delimiter=',')
        savetxt(f'losses/train_counter_median_bs_{bs}.csv', train_counter, delimiter=',')
