...
from src.networks.mnist_std_dataset import MNISTStdDataset
import torch
...
def main():
    ...
    train_dataset = MNISTStdDataset(train.data, transform=transforms.ToTensor)
    test_dataset = MNISTStdDataset(test.data, transform=transforms.ToTensor)
    ...
    for bs in batch_sizes:
        ...
        savetxt(f'losses/bs_std/test_counter_std_bs_{bs}.csv', test_counter, delimiter=',')
        savetxt(f'losses/bs_std/test_losses_std_bs_{bs}.csv', test_losses, delimiter=',')
        savetxt(f'losses/bs_std/train_losses_std_bs_{bs}.csv', train_losses, delimiter=',')
        savetxt(f'losses/bs_std/train_counter_std_bs_{bs}.csv', train_counter, delimiter=',')
