...
def main():
    ...
    for bs in batch_sizes:
        ...
        # savetxt('results/test_counter_bs.csv', test_counter, delimiter=',')
        # savetxt('results/test_losses_bs.csv', test_losses, delimiter=',')
        # savetxt('results/train_losses_bs.csv', train_losses, delimiter=',')
        # savetxt('results/train_counter_bs.csv', train_counter, delimiter=',')
...
if __name__ == '__main__':
    ...
    with open('results/batch_size_std.csv', mode='w') as file:
